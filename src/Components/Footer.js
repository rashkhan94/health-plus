    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:info@healthpluscare.com">info@healthpluscare.com</a>
            </li>
            <li>
              <a href="mailto:bookings@healthpluscare.com">
                bookings@healthpluscare.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2010-2025 Health+. All rights reserved.</p>
